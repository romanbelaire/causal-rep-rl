...
#SBATCH --output=%u.rstr_impala_icnn_weak.%j.out
#SBATCH --requeue
...
#SBATCH --job-name=rstr-impala-icnn-weak
...
srun --gres=gpu:1 python -m src.main --config configs/exp5_rstr_impala_icnn_weak_mu.json
