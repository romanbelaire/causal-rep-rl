...
#################################################
## REPRESENTATIONAL PPO: IMPALA + VAE CRITIC  ##
#################################################
...
#SBATCH --output=%u.repr_ppo_impala_vae.%j.out
#SBATCH --requeue
...
#SBATCH --job-name=repr-ppo-impala-vae
...
# Run training
srun --gres=gpu:1 python -m src.main --config configs/exp2_repr_ppo_impala_vae.json
