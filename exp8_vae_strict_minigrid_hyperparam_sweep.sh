...
CONFIGS=("configs/exp8_rstr_impala_vae_strict_soft_minigrid.json" "configs/exp8_rstr_impala_vae_strict_warmup400_minigrid.json" "configs/exp8_rstr_impala_vae_strict_reprmatch_minigrid.json")
SEEDS=(42 43 44)
