...
CONFIGS=("configs/exp8_rstr_impala_vae_strict_warmup400_quadratic_latent_minigrid.json" "configs/exp8_rstr_impala_vae_strict_warmup400_quadratic_latent_mumin_minigrid.json" "configs/exp8_rstr_impala_vae_strict_warmup400_squared_norm_minigrid.json")
SEEDS=(42 43 44)
