...
#################################################
## VANILLA TRPO BASELINE: IMPALA + MLP CRITIC ##
#################################################
...
#SBATCH --output=%u.vanilla_trpo_impala_mlp.%j.out
#SBATCH --requeue
...
#SBATCH --job-name=vanilla-trpo-impala-mlp
...
# Run training
srun --gres=gpu:1 python -m src.main --config configs/exp1_vanilla_trpo_impala_mlp.json
