...
# Train ONE DMControl task (array index selects it) with CTRO (MLP-encoder stack,
# serial rollout num_envs=1). Each task gets its own allocation, and inside it the 3
