...
#SBATCH --output=%u.pl_only_s_.%j.out
#SBATCH --error=%u.pl_only_s_.%j.err
#SBATCH --requeue
...
srun --gres=gpu:1 python -m src.experiments.exp_pl_only --seed 42 --beta 0.1 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_pl_only --seed 43 --beta 0.1 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_pl_only --seed 44 --beta 0.1 --device cuda
