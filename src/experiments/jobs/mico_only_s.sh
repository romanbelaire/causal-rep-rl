...
#SBATCH --output=%u.mico_only_s_.%j.out
#SBATCH --error=%u.mico_only_s_.%j.err
#SBATCH --requeue
#SBATCH --partition=researchshort
#SBATCH --account=pradeepresearch
#SBATCH --qos=research-1-qos
#SBATCH --mail-user=rbelaire.2021@phdcs.smu.edu.sg
#SBATCH --job-name=ctro-mico-only
...
srun --gres=gpu:1 python -m src.experiments.exp_mico_only --seed 42 --alpha 0.1 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_mico_only --seed 43 --alpha 0.1 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_mico_only --seed 44 --alpha 0.1 --device cuda
