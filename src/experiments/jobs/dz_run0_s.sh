...
#SBATCH --output=/ocean/projects/cis260223p/rbelaire/causal-rep-rl/logs/dz_run0_%j.out
#SBATCH --error=/ocean/projects/cis260223p/rbelaire/causal-rep-rl/logs/dz_run0_%j.err
#SBATCH --job-name=dz-run0
#
# Run 0: eta sweep on cartpole-swingup (constraint sanity).
...
bash src/experiments/jobs/dz_phase3.sh run0
