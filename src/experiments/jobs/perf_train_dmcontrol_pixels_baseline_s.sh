...
#SBATCH --output=%u.perf_train_dmcontrol_pixels_baseline_s_%a.%j.out
#SBATCH --requeue
#SBATCH --partition=researchshort
#SBATCH --account=pradeepresearch
#SBATCH --qos=research-1-qos
#SBATCH --mail-user=rbelaire.2021@phdcs.smu.edu.sg
#SBATCH --job-name=ppo-train-dmc-pix

# DMControl pixels PPO baseline (Impala on RGB). Suite defaults use shared t8 knobs.
# Checkpoints -> results/dmcontrol_pixels/exp_baseline/seed_{N}/{task}/
