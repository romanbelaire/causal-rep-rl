...
#SBATCH --output=%u.perf_train_dmcontrol_pixels_latent_nolink_s_%a.%j.out
#SBATCH --requeue
#SBATCH --partition=researchshort
#SBATCH --account=pradeepresearch
#SBATCH --qos=research-1-qos
#SBATCH --mail-user=rbelaire.2021@phdcs.smu.edu.sg
#SBATCH --job-name=nolink-train-dmc-pix

# DMControl pixels latent_nolink: CTRO CNN-encoder stack, alpha=beta=0.
# Checkpoints -> results/dmcontrol_pixels/exp_latent_nolink/seed_{N}/{task}/
...
RESULTS_SUBDIR=dmcontrol_pixels
EXP_NAME="${EXP_NAME:-exp_latent_nolink}"
EXTRA_ARGS=(--agent ctro --alpha 0 --beta 0 --alpha-warmup-epochs 0 --beta-warmup-epochs 0)
