...
#SBATCH --output=%u.perf_train_dmcontrol_pixels_ctro_s_%a.%j.out
#SBATCH --requeue
#SBATCH --partition=researchshort
#SBATCH --account=pradeepresearch
#SBATCH --qos=research-1-qos
#SBATCH --mail-user=rbelaire.2021@phdcs.smu.edu.sg
#SBATCH --job-name=ctro-train-dmc-pix

# DMControl pixels CTRO (non-VAE CNN encoder, policy-on-Z). Suite defaults:
# t8 alpha/beta + 500-epoch warmup, vae_coef=0.
# Checkpoints -> results/dmcontrol_pixels/exp_ctro/seed_{N}/{task}/
