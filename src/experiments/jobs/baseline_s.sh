...
#SBATCH --output=%u.baseline_s_.%j.out
#SBATCH --error=%u.baseline_s_.%j.err
#SBATCH --requeue
...
srun --gres=gpu:1 python -m src.experiments.exp_baseline --seed 42 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_baseline --seed 43 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_baseline --seed 44 --device cuda
