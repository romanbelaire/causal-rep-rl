...
#SBATCH --output=%u.full_a0p1_b0p5_s_.%j.out
#SBATCH --requeue
#SBATCH --partition=researchshort
#SBATCH --account=pradeepresearch
#SBATCH --qos=research-1-qos
#SBATCH --mail-user=rbelaire.2021@phdcs.smu.edu.sg
#SBATCH --job-name=ctro-full-a0p1-b0p5
...
srun --gres=gpu:1 python -m src.experiments.exp_full --seed 42 --alpha 0.1 --beta 0.5 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_full --seed 43 --alpha 0.1 --beta 0.5 --device cuda
srun --gres=gpu:1 python -m src.experiments.exp_full --seed 44 --alpha 0.1 --beta 0.5 --device cuda
