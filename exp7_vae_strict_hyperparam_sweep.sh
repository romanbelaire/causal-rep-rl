...
CONFIGS=("configs/exp4_rstr_impala_vae_strict_soft.json" "configs/exp4_rstr_impala_vae_strict_warmup400.json" "configs/exp4_rstr_impala_vae_strict_reprmatch.json")
SEEDS=(42 43 44)
