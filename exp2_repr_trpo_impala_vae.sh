...
#################################################
## REPRESENTATIONAL TRPO: IMPALA + VAE CRITIC ##
#################################################
...
#SBATCH --output=%u.repr_trpo_impala_vae.%j.out
#SBATCH --requeue
...
#SBATCH --job-name=repr-trpo-impala-vae
...
# Run training
srun --gres=gpu:1 python -m src.main --config configs/exp2_repr_trpo_impala_vae.json
